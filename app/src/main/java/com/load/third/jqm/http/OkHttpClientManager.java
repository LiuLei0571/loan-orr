...
public class OkHttpClientManager {
    ...
    public static void downloadAsynWithName(String url, String destDir, String fileName, ResultCallback callback) {
    ...
    private void deliveryResult(final ResultCallback callback, Request request) {
        mOkHttpClient.newCall(request).enqueue(new Callback() {
            ...
            public void onResponse(final Response response) {
                ...
                {
                    sendFailedStringCallback("-JSON解析错误", response.request(), e, callback);
                }
    ...
    private void sendFailedStringCallback(final String error, final Request request, final Exception e, final ResultCallback callback) {
