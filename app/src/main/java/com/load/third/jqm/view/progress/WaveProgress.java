package com.load.third.jqm.view.progress;
...
public class WaveProgress extends View {
    ...
    private void initAttrs(Context context, AttributeSet attrs) {
        ...
        mDarkWaveAnimTime = typedArray.getInt(R.styleable.WaveProgress_darkWaveAnimTime, ProgressConstant.DEFAULT_ANIM_TIME);
        mLightWaveAnimTime = typedArray.getInt(R.styleable.WaveProgress_lightWaveAnimTime, ProgressConstant.DEFAULT_ANIM_TIME);
        mMaxValue = typedArray.getFloat(R.styleable.WaveProgress_maxValue, ProgressConstant.DEFAULT_MAX_VALUE);
        mValue = typedArray.getFloat(R.styleable.WaveProgress_value, ProgressConstant.DEFAULT_VALUE);
        mValueSize = typedArray.getDimension(R.styleable.WaveProgress_valueSize, ProgressConstant.DEFAULT_VALUE_SIZE);
        ...
        mHintSize = typedArray.getDimension(R.styleable.WaveProgress_hintSize, ProgressConstant.DEFAULT_HINT_SIZE);

        mCircleWidth = typedArray.getDimension(R.styleable.WaveProgress_circleWidth, ProgressConstant.DEFAULT_ARC_WIDTH);
        ...
        mWaveHeight = typedArray.getDimension(R.styleable.WaveProgress_waveHeight, ProgressConstant.DEFAULT_WAVE_HEIGHT);
