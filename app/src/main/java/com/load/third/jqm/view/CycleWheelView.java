...
public class CycleWheelView extends ListView {
    ...
    private static final int COLOR_DIVIDER_DEFALUT = Color.TRANSPARENT;
    private static final int HEIGHT_DIVIDER_DEFAULT = 2;
    private static final int COLOR_SOLID_DEFAULT = Color.TRANSPARENT;
    private static final int COLOR_SOLID_SELET_DEFAULT = Color.TRANSPARENT;
    ...
    private int mLabelSelectTextSize = 30;
    private int mLabelTextSize = 12;

    /**
     * Gradual Alph
     */
    private float mAlphaGradual = 0.6f;
    ...
    private void init() {
        ...
        mItemLayoutId = R.layout.item_wheel_view;
    ...
    private void resetItems(int firstPosition, int position, int offset) {
        for (int i = position - offset - 1; i < position + offset + 1; i++) {
            ...
            if (position == i) {
                ...
                labelTv.setTextSize(mLabelSelectTextSize);
                itemView.setAlpha(1f);
            } else {
                labelTv.setTextColor(mLabelColor);
                labelTv.setTextSize(mLabelTextSize);
...
//        resetItems(getFirstVisiblePosition( ), mCurrentPositon, mWheelSize / 2);
     ...
     * @param textSize
     */
    public void setLabelSelectTextSize(int textSize) {
        this.mLabelSelectTextSize = textSize;
//        resetItems(getFirstVisiblePosition( ), mCurrentPositon, mWheelSize / 2);
    }
...
//        mItemHeight = getResources( ).getDimensionPixelSize(R.dimen.item_wheel_view_height);
